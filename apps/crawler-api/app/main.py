...
tags_metadata = [
    {
        "name": "Service",
        "description": "**(服务信息与健康检查/Service info and health checks)**",
    },
    {
        "name": "Hybrid-API",
    ...
    },
    {
        ...
        "description": "**(快手Web数据接口/Kuaishou-Web-API data endpoints)**",
    },
    {
        "name": "Xiaohongshu-Web-API",
        "description": "**(小红书Web数据接口/Xiaohongshu-Web-API data endpoints)**",
    },
    {
        "name": "Weibo-Web-API",
        "description": "**(微博Web数据接口/Weibo-Web-API data endpoints)**",
    },
    {
        "name": "iOS-Shortcut",
